sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/yr/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("com.yr.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/yr/localService/mockserver"], function (mockserver) {
